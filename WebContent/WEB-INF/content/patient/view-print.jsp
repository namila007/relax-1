							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-xs-1">
										...
										<s:a href="%{#patientPrintUrl}" cssClass="btn btn-info">Print Full details</s:a>
									</div>
									<div class="col-xs-1">
										<s:url var="patientPrintUrl" namespace="/patient" action="print.html">
											<s:param name="id" value="%{patient.id}"></s:param>
										</s:url>
										<s:a href="%{#patientPrintUrl}" cssClass="btn btn-info">Print file cover</s:a>
									</div>
									<div class="col-xs-1">
										<s:url var="patientPrintUrl" namespace="/patient" action="print.html">
											<s:param name="id" value="%{patient.id}"></s:param>
										</s:url>
										<s:a href="%{#patientPrintUrl}" cssClass="btn btn-info">Print patient card</s:a>
									</div>									
								</div>
							</div>					
