					...
					<div class="container">
						<div class="row">
							...
							<div style="color: red; font-size: 20px;"
								class="col-sm-4 col-xs-12">Developmental</div>
						...
						<div class="row">
							<div style="color: red; font-size: 20px;"
								class="col-sm-4 col-xs-12">Epilepsy</div>
						...
						<div class="row">
							<div style="color: red; font-size: 20px;"
								class="col-sm-4 col-xs-12">Endocrine</div>
							<div class="col-sm-4 col-xs-8">
								<div>Diabetes</div>
						...
						<div class="row">
							<div style="color: red; font-size: 20px;"
								class="col-sm-4 col-xs-12">Gastro-intestinal</div>
							<div class="col-sm-4 col-xs-8">
								<div>Ulcers</div>
