						...
						<div id="London" class="tabcontent" style="overflow-y: scroll; height:500px;">
			                <div class="containerbody">
			                    ...
			                    <div class="row">
			                        ...
			                        <div class="col-sm-4">
			                            <input type="text" name="Dose_Warfarin" placeholder="Dose Regime"><br>
			                        </div>
			                        <div class="col-sm-4">
			                            <input type="text" name="Duration_Warfarin"
			                                placeholder="Duration"><br>
			                        </div>
			                    </div>
			                    <div class="row">
			                   ...
			                   <div class="row">
			                        ...
			                        <div class="col-sm-4">
			                            <input type="text" name="Dose_Aspirin" placeholder="Dose Regime"><br>
			                        </div>
			                        <div class="col-sm-4">
			                            <input type="text" name="Duration_Aspirin" placeholder="Duration"><br>
			                        </div>
			                    </div>
			                    ...
			                    <div class="row">
			                        ...
			                        <div class="col-sm-4">
			                            <input type="text" name="Duration_Other" placeholder="Duration">
			                        </div>
		                    ...
		                    <div class="row">
		                        ...
		                        <div class="col-sm-3">
		                            <input type="text" name="Antidiabetes" placeholder="Antidiabetes"><br>
		                        </div>
		                        <div class="col-sm-3">
							...
							<div class="containerbody">
			                   <div class="row">
			                    ...
			                    <div class="row">
			                        ...
			                        <div class="col-sm-3">
			                            <input type="text" name="Duration_NSAIDS" placeholder="Duration"><br>
			                        </div>
			                    </div>
