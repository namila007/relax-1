				...
				<s:form namespace="/patient" action="processRegister.html"
					...
					<ul class="nav nav-tabs" id="myTab" role="tablist">
						<li class="nav-item"><a class="nav-link"
							id="investigation-tab" data-toggle="tab" href="#investigation"
							role="tab" aria-controls="investigation" aria-selected="true">Investigation</a>
						</li>
						<li class="nav-item"><a class="nav-link" id="habits-tab"
							data-toggle="tab" href="#habits" role="tab"
							aria-controls="habits" aria-selected="false">Habits</a></li>
					</ul>
										...
										<div class="row">
											...
											<div class="col-md-2 col-sm-1 col-xs-12">
												...
												<s:textfield required="required" title="smokeDuration"
													...
													name="investigation.smokeDuration"
													placeholder="Smoke Duration" />
											</div>
										</div>
									</div>
									<div class="form-group required">
										<div class="row">
											...
											<div class="col-md-3 col-sm-2 col-xs-12"
												...
												<s:textfield required="required" title="betelDuration"
													...
													name="investigation.betelDuration"
													placeholder="Betel Duration" />
										...
										<div class="row">
											...
											<div class="col-md-2 col-sm-1 col-xs-12">
												...
												<s:textfield required="required" title="alcoholDuration"
													...
													name="investigation.alcoholDuration"
													placeholder="Alcohol Duration" />
											</div>
										</div>
