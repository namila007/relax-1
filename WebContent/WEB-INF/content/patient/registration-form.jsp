...
<div class="form-group">
	<div class="row">
		...
		<div class="col-xs-3">
		  	<input type="text" class="form-control" id="name" name="surName" placeholder="Surname">
		</div>                
		<div class="col-xs-2">
		  <input type="text" class="form-control" id="name" name="initials" placeholder="Initials">
		</div>
		<div class="col-xs-3">
...
<div class="form-group">
	<div class="row">
		<div class="col-xs-2">
		 	<label for="serialNumber">NIC number:</label> 
		</div>
		<div class="col-xs-5">
